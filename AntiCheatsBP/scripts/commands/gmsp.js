    ...
    if (targetPlayerName) {
        ...
        if (targetPlayer) {
            try {
                ...
                playerUtils.debugLog(`[GMSPCommand] Error setting gamemode for ${targetPlayer.nameTag}: ${e.message}`, dependencies, player.nameTag);
        ...
        try {
            ...
            playerUtils.debugLog(`[GMSPCommand] Error setting own gamemode: ${e.message}`, dependencies, player.nameTag);
