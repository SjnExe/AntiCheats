...
// import { getString } from '../../../core/i18n.js'; // If needed for this file

/**
 * @typedef {import('../../types.js').PlayerAntiCheatData} PlayerAntiCheatData
 * @typedef {import('../../types.js').Config} Config
 * @typedef {import('../../types.js').PlayerUtils} PlayerUtils
 * @typedef {import('../../types.js').ActionManager} ActionManager // Assuming ActionManager is in dependencies
 ...
 */
export async function checkChatContentRepeat(player, pData, rawMessageContent, dependencies) {
    const { config, playerUtils, actionManager, ...restOfDependencies } = dependencies;
    ...
    if (matchCount >= triggerThreshold) {
        ...
        // Use the correct dependencies object for executeCheckAction
        ...
        // Optional: Clear history after flagging to prevent immediate re-flags if desired.
