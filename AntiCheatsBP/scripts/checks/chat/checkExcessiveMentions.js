 ...
 */
export async function checkExcessiveMentions(player, pData, rawMessageContent, dependencies) {
    ...
    if (!pData) {
        playerUtils.debugLog?.("ExcessiveMentions: pData is null, skipping check.", player.nameTag);
        return;
    }
