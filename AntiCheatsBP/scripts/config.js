...
Rule 6: Have fun and contribute to a positive community!`,
    ...
    checks: {
        reach: { enabled: false },
        cps: { enabled: false },
        viewSnap: { enabled: false },
        multiTarget: { enabled: false },
        stateConflict: { enabled: false },
        fly: { enabled: false },
        speed: { enabled: false },
        nofall: { enabled: false },
        nuker: { enabled: false },
        illegalItem: { enabled: false },
        selfHurt: { enabled: false },
        netherRoof: { enabled: false },
        noSlow: { enabled: false },
        invalidSprint: { enabled: false },
        autoTool: { enabled: false },
        instaBreak: { enabled: false },
        nameSpoof: { enabled: false },
        antiGmc: { enabled: false },
        inventoryMod: { enabled: false },
        tower: { enabled: false },
        fastUse: { enabled: false },
