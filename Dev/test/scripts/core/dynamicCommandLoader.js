 ...
 * @param {Map<string, string>} commandFilePaths
 * @param {Map<string, import('../types.js').CommandDefinition>} commandDefinitionMap
 * @param {Map<string, import('../types.js').CommandExecuteFunction>} commandExecutionMap
 ...
 */
export async function loadCommand(commandName, dependencies, commandFilePaths, commandDefinitionMap, commandExecutionMap) {
